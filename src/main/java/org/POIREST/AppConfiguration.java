    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.POIREST");
                servletContext.setInitParameter("tapestry.development-modules", "org.POIREST.services.DevelopmentModule");
